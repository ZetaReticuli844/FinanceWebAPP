...
const CreateUser = () => {
  ...
  <div className="flex items-start mb-5">
    <label  className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Already have an account <Link to='/login' className='text-blue-500'>Login here</Link></label>
  </div>
